...
coders/min_heap.c coders/min_heap_utils.c coders/utils.c coders/threads.c coders/dongles.c coders/action.c\
coders/free_clean.c coders/coder_routine.c coders/monitor.c coders/utils2.c coders/ft_atoi.c
OBJ=$(SRC:%.c=%.o)
